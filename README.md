...
{
    "rdf.source" : "ZODB",
    "rdf.store_conf" : "$HERE/.pow/worm.db"
}
```

`$HERE` is resolved by PyOpenWorm to the location of the config file.
